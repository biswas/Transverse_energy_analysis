...
\begin{figure}[h]
  \centering
  \includegraphics[width=7.5in]{figures/RHIC_Layout.jpeg}
...
The Large Hadron Collider (LHC) is located underground (between 45m and 170m) beneath the France-Switzerland border near the city of  Geneva. The two rings of the collider were constructed between 1998 and 2008 by the European Organization for Nuclear Research (CERN) in the 26.7 km circular tunnel originally housing CERN's Large Electron-Positron collider. Just like the RHIC, the LHC gets its beams prepared by a series of machines in different stages. It has the ability to collide species (p+p, p+A, Pb+Pb) at upto 2.76 TeV per nucleon. The collisions occur at the location of the four big LHC experiments: Compact Muon Solenoid (CMS), ATLAS, LHCb, and ALICE. ALICE is dedicated to the study of heavy-ion collisions. \cite{1748-0221-3-08-S08001}
