...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Transverse energy analysis of relativistic heavy ion collisions through the use of identified particles spectra\\
Or\\
Collision Energy and Participant Number Scalings of Identified Hadrons Transverse Energies and Charged Particle Multiplicities from Au+Au Collisions at $\sqrt{s_{NN}} =  7.7, 11.5, 19.6, 27, and 39 GeV$}	       	% title of thesis/dissertation
...
\utbiblio{#1}{apalike}{references-Biswas}
