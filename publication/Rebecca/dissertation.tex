...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Transverse energy of particles produced in Au+Au collisions from the beam energy scan program}	       % title of thesis/dissertation
...
\majorProfessor{Christinne Nattrass}	    % advisor's name
...
%    \listoffigures % generate a list of figures
    ...
    \bibliography{references/references-Biswas} % references.bib included in the references directory
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
