...
int BESData_sorted_transformed(){ // main
	...
	in.open(Form("/home/bsharma/rhip/trialCodes/BESData_sorted.txt"));
	// ^ data file with Beam Scan Energy data, !!!!!!bins sorted!!!!!
	TFile* f = new TFile("BESData_transformed.root","RECREATE");// .root file to be created
