// what's different from fitBESData4_1.cpp:
	// location of breakoutfortesting++ & if statement following it: checked
	// ofstream:app : checked
	// header skipped in datFile : checked
	// name of main function: checked
...
// main function:
int fitBESData4_2(){
	std::ofstream datFile ("fitResults4.dat", std::ofstream::app);
	/*
	datFile << "CollEn"<< "\t"	
			<< "particle" << "\t"
			<< "mass" << "\t"
	...
	*/
	...
	int stop =280; // breakOut after this many iterations (if achieved); default: 140
	while((mikey=(TKey*)next())){// FIXME!!! delete mikey at the end of every loop
		...
		//funcBGBW_top = new TF1("getdNdpt",,0.00000000000001,10.,5)
		...
		// Error in functional integration:
		// Get function using upper end of data points, i.e., point+error: f_top
		// Get function using lower end of data points, i.e., point-error: f_bottom
		// find all quantities of interest using f_top and f_bottom
		// Error in each quantity = Q(f_top)-Q(f_bottom)
		// ---End of - Add to fitBESData4_2.cpp -//////
